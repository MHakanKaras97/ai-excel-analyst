...
def interpret_multi_file_chart_question(question: str, column_names: list[str], file_labels: list[str],
                                         provider: AIProvider) -> dict:
    prompt = build_multi_file_chart_intent_prompt(question, column_names, file_labels)
